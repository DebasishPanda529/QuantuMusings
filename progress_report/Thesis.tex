...
%\input{Chapters/Chapter3} % NEGF Formalism

%\input{Chapters/Chapter4} % Intro to Supercoductivity
...
\input{Appendices/AppendixA} % Fourier Transforming the Interacting Fermion Gas Hamiltonian

\input{Appendices/AppendixB} % Bloch's Theorem
